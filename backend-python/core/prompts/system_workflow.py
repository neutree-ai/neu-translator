"""
System workflow prompt for the translation agent.
"""


def SYSTEM_WORKFLOW(current_memory: str = "") -> str:
    """Generate the system workflow prompt with optional memory."""
    memory_section = ""
    if current_memory:
        memory_section = f"""
# User preferences
...
{current_memory}"""
    ...
    return f"""You are a professional translation assistant; working with the user, translate files completely and ensure translations meet user requirements.
